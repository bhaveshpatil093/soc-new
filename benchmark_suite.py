...
def main() -> None:
    ...
    models = {
        ...
        "Autoencoder": AutoencoderDetector(
            feature_columns=cont_features, hidden_dim=8, latent_dim=3, epochs=10, batch_size=256, version="1.0"
        ),
        "SequenceLSTM": SequenceLSTMDetector(
            feature_columns=cont_features, seq_len=10, hidden_dim=16, num_layers=1, epochs=5, batch_size=128, version="1.0"
        ),
    ...
    print("Validation set: 5 days (2000 windows/day)")
    print("-" * 80)
