...
class TestTemporalLeakageEnforcement:
    ...
    def test_fitting_with_august_data_raises_error(self):
        """
        ...
        july_end_bound = datetime(2025, 8, 1, tzinfo=timezone.utc)
        ...
        leakage_data = pa.table({
            "timestamp": [
                ...
                datetime(2025, 8, 2, tzinfo=timezone.utc) # August data point
            ],
            "value": [1.0, 2.0]
        })
    ...
    def test_fitting_with_july_only_data_succeeds(self):
        """
